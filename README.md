...
The goals / steps of this project are the following:m
...
1. The dataset in which we've already resized the images to 32x32 can be downloaded from [here](https://d17h27t6h515a5.cloudfront.net/topher/2016/October/580d53ce_traffic-sign-data/traffic-sign-data.zip).
